 ...
 */
final class Version20230406070245 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, label, image FROM category');
        $this->addSql('DROP TABLE category');
        $this->addSql('CREATE TABLE category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL, image CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO category (id, label, image) SELECT id, label, image FROM __temp__category');
        $this->addSql('DROP TABLE __temp__category');
    }
}
